...
KO_2_1 = (
    ...
    "생성된 Map은 중앙 저장소에 적재되며 분석 Web App[5]으로 대량 조회·분석이 가능하다."
)
...
KO_2_3_B = (
    ...
    "나머지 6개는 일부 lot 국한 warning이거나 실제 불량으로 이어지지 않는 패턴이었다."
)
...
if __name__ == "__main__":
    doc_ko = _build("ko")
    out_ko = OUT_DIR / "paper_codex_2page_rev163.docx"
    doc_ko.save(str(out_ko))
    print(f"saved: {out_ko}")

    doc_en = _build("en")
    out_en = OUT_DIR / "paper_codex_2page_rev163_en.docx"
