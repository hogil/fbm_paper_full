...
ABSTRACT_EN = (
    ...
    "However, in practical operations, large-scale retrieval and inspection of Failbit Maps have been impractical, and even the limited analysis that was feasible relied heavily on manual inspection by engineers. "
...
KO_2_3_B = (
    ...
    "나머지 6개 그룹은 일부 lot에 국한된 warning 수준의 noise이거나 실제 chip 불량으로 이어지지 않는 패턴으로 해석되었다."
)
...
EN_2_1 = (
    ...
    "enabling engineers to browse and analyze thousands of maps per session, a scale that was previously infeasible."
)
...
EN_2_2_B = (
    ...
    "To compensate for this, the second stage was configured so that ROI-based YOLO re-examines low-confidence samples and detects defect-chip morphology and appearance patterns within the ROI (Fig. 3)."
)
...
if __name__ == "__main__":
    doc_ko = _build("ko")
    out_ko = OUT_DIR / "paper_codex_2page_rev162.docx"
    doc_ko.save(str(out_ko))
    print(f"saved: {out_ko}")

    doc_en = _build("en")
    out_en = OUT_DIR / "paper_codex_2page_rev162_en.docx"
