...
본 연구는 대량 Failbit Map 생성 파이프라인과 Known·Unknown 불량 분석 AI를 통합 구현하였다. 데이터 계층에서는 1시간 주기 생성과 저장 효율을 확보하였고, Known 경로는 F1 0.95를, Unknown 경로는 운영 이미지에서 13개 후보 그룹과 7개 실제 불량 그룹을 검출하였다. 이를 통해 Failbit Map 기반 불량 분석의 실제 운영 적용이 가능한 End-to-End 체계를 제시하였다.
