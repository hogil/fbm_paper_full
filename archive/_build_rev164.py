...
ABSTRACT_EN = (
    ...
    "However, in practical operations, large-scale retrieval and inspection of Failbit Maps have not been possible in practice, and even the limited analysis that was feasible relied heavily on manual inspection by engineers. "
...
EN_2_2_B = (
    ...
    "To compensate for this, the second stage was configured so that ROI-based YOLO re-examines low-confidence samples and identifies chip-level defect morphologies and appearance patterns within the ROI (Fig. 3)."
)
...
if __name__ == "__main__":
    doc_ko = _build("ko")
    out_ko = OUT_DIR / "paper_codex_2page_rev164.docx"
    doc_ko.save(str(out_ko))
    print(f"saved: {out_ko}")

    doc_en = _build("en")
    out_en = OUT_DIR / "paper_codex_2page_rev164_en.docx"
