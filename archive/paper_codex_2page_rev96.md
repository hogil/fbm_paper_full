...
**Fig. 3.** Known 불량 2단계 분류 예시. 두 클래스는 불량 chip의 위치는 유사하지만 chip 내부 defect pixel morphology가 다르다. 우측 예시에서 1단계 CNN은 Class B로 오분류하였으나, ROI 기반 YOLO가 chip 내부 국소 pattern을 검출하여 최종적으로 Class A로 교정하였다.
