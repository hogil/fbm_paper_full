...
- `구현 성과`
  - `[정량적/정성적 성과]`
  - 기술 지표: 모델 정확도 향상, 추론 속도 개선, 데이터 처리 성능 등
  - 현업 임팩트: 수율 향상, 불량률 감소, 품질 강화, 검토 시간 절감, 신규 후보 발굴 등 실제 기여도
...
3. 서류 간 정합성 확보
   - 데이터 일관성: `01_career_profile.md` 와 `02_ai_portfolio.md` 사이의 프로젝트명, 수행기간, 본인 역할, 기여도 정보가 모두 일치해야 한다.
