...
![DRAM cell에서 좌표 보존 Failbit Map까지](figures/full_paper_rev173/fig01_dram_to_fbm.png)
...
![좌표 보존 분석 파이프라인](figures/full_paper_rev173/fig02_pipeline_architecture.png)
...
![ROI-YOLO 2-stage 검출](figures/full_paper_rev173/fig03_roi_yolo.png)
...
![object-id map 생성 흐름](figures/full_paper_rev173/fig04_objid_flow.png)
...
![chip 라벨 공간 예시](figures/full_paper_rev173/fig05_chip_label_space.png)
...
![FCM-PM augmentation](figures/full_paper_rev173/fig06_fcm_pm.png)
...
![val_margin selection and NB-reject sidecar](figures/full_paper_rev173/fig07_probability_control.png)
...
![운영 web app(map viewer) 화면](figures/full_paper_rev173/fig09_webapp_viewer.png)
