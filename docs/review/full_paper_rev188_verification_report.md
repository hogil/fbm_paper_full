# full_paper_rev188_codex verification report
...
## Passed Checks
- markdown exists: D:\project\fbm_paper_full\full_paper_rev188_codex.md
- DOCX exists: D:\project\fbm_paper_full\full_paper_rev188_codex.docx
- PDF exists: D:\project\fbm_paper_full\full_paper_rev188_codex.pdf
- markdown title line exists
- markdown Abstract heading is bold
- markdown uses current figure folder: figures/full_paper_rev188
- markdown has no stale figure folders
- markdown risk-pattern scan complete
- markdown standalone abbreviation scan passed
- figure file exists: figures/full_paper_rev188/fig01_dram_to_fbm.png
- figure file exists: figures/full_paper_rev188/fig02_pipeline_architecture.png
- figure file exists: figures/full_paper_rev188/fig03_roi_yolo.png
- figure file exists: figures/full_paper_rev188/fig04_objid_flow.png
- figure file exists: figures/full_paper_rev188/fig05_chip_label_space.png
- figure file exists: figures/full_paper_rev188/fig06_fcm_pm.png
- figure file exists: figures/full_paper_rev188/fig07_probability_control.png
- figure file exists: figures/full_paper_rev188/fig_objid_compare.png
- figure file exists: figures/full_paper_rev188/fig09_webapp_viewer.png
