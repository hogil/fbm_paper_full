# full_paper_rev191_codex verification report
...
## Failures
- PDF missing: D:\project\fbm_paper_full\full_paper_rev191_codex.pdf
...
- render folder missing: D:\project\fbm_paper_full\tmp\docs\full_paper_rev191_pages

## Passed Checks
- markdown exists: D:\project\fbm_paper_full\full_paper_rev191_codex.md
- DOCX exists: D:\project\fbm_paper_full\full_paper_rev191_codex.docx
- markdown title line exists
- markdown Abstract heading is bold
- markdown uses current figure folder: figures/full_paper_rev191
- markdown has no stale figure folders
- markdown risk-pattern scan complete
- markdown standalone abbreviation scan passed
- figure file exists: figures/full_paper_rev191/fig01_dram_to_fbm.png
- figure file exists: figures/full_paper_rev191/fig02_pipeline_architecture.png
- figure file exists: figures/full_paper_rev191/fig03_roi_yolo.png
- figure file exists: figures/full_paper_rev191/fig04_objid_flow.png
- figure file exists: figures/full_paper_rev191/fig05_chip_label_space.png
- figure file exists: figures/full_paper_rev191/fig06_fcm_pm.png
- figure file exists: figures/full_paper_rev191/fig07_probability_control.png
- figure file exists: figures/full_paper_rev191/fig_objid_compare.png
- figure file exists: figures/full_paper_rev191/fig09_webapp_viewer.png
