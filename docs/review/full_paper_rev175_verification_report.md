# full_paper_rev175_codex verification report
...
## Passed Checks
- markdown exists: D:\project\fbm_paper_full\full_paper_rev175_codex.md
- DOCX exists: D:\project\fbm_paper_full\full_paper_rev175_codex.docx
- PDF exists: D:\project\fbm_paper_full\full_paper_rev175_codex.pdf
- markdown title line exists
- markdown Abstract heading is bold
- markdown uses current figure folder: figures/full_paper_rev175
- markdown has no stale figure folders
- markdown risk-pattern scan complete
- markdown standalone abbreviation scan passed
- figure file exists: figures/full_paper_rev175/fig01_dram_to_fbm.png
- figure file exists: figures/full_paper_rev175/fig02_pipeline_architecture.png
- figure file exists: figures/full_paper_rev175/fig03_roi_yolo.png
- figure file exists: figures/full_paper_rev175/fig04_objid_flow.png
- figure file exists: figures/full_paper_rev175/fig05_chip_label_space.png
- figure file exists: figures/full_paper_rev175/fig06_fcm_pm.png
- figure file exists: figures/full_paper_rev175/fig07_probability_control.png
- figure file exists: figures/full_paper_rev175/fig09_webapp_viewer.png
...
- DOCX app Words is nonzero: 10345
