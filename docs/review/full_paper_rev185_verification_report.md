# full_paper_rev185_codex verification report
...
## Passed Checks
- markdown exists: D:\project\fbm_paper_full\full_paper_rev185_codex.md
- DOCX exists: D:\project\fbm_paper_full\full_paper_rev185_codex.docx
- PDF exists: D:\project\fbm_paper_full\full_paper_rev185_codex.pdf
- markdown title line exists
- markdown Abstract heading is bold
- markdown uses current figure folder: figures/full_paper_rev185
- markdown has no stale figure folders
- markdown risk-pattern scan complete
- markdown standalone abbreviation scan passed
- figure file exists: figures/full_paper_rev185/fig01_dram_to_fbm.png
- figure file exists: figures/full_paper_rev185/fig02_pipeline_architecture.png
- figure file exists: figures/full_paper_rev185/fig03_roi_yolo.png
- figure file exists: figures/full_paper_rev185/fig04_objid_flow.png
- figure file exists: figures/full_paper_rev185/fig05_chip_label_space.png
- figure file exists: figures/full_paper_rev185/fig06_fcm_pm.png
- figure file exists: figures/full_paper_rev185/fig07_probability_control.png
- figure file exists: figures/full_paper_rev185/fig_objid_compare.png
- figure file exists: figures/full_paper_rev185/fig09_webapp_viewer.png
