# full_paper_rev201_codex verification report
...
- body paragraph alignment is not justified: 1. 서론; 2. 본론; 2.1.1. 데이터 표현과 정합 적재; 2.1.2. Known failure 분류 구조; 2.1.3. Unknown failure 군집화 구조
...
- render folder missing: D:\project\fbm_paper_full\tmp\docs\full_paper_rev201_pages

## Passed Checks
- markdown exists: D:\project\fbm_paper_full\full_paper_rev201_codex.md
- DOCX exists: D:\project\fbm_paper_full\full_paper_rev201_codex.docx
- PDF exists: D:\project\fbm_paper_full\full_paper_rev201_codex.pdf
- markdown title line exists
- markdown Abstract heading is bold
- markdown uses current figure folder: figures/full_paper_rev201
- markdown has no stale figure folders
- markdown risk-pattern scan complete
- markdown standalone abbreviation scan passed
- figure file exists: figures/full_paper_rev201/fig01_dram_to_fbm.png
- figure file exists: figures/full_paper_rev201/fig02_pipeline_architecture.png
- figure file exists: figures/full_paper_rev201/fig03_roi_yolo.png
- figure file exists: figures/full_paper_rev201/fig04_objid_flow.png
- figure file exists: figures/full_paper_rev201/fig05_chip_label_space.png
- figure file exists: figures/full_paper_rev201/fig06_fcm_pm.png
- figure file exists: figures/full_paper_rev201/fig07_probability_control.png
- figure file exists: figures/full_paper_rev201/fig_objid_compare.png
- figure file exists: figures/full_paper_rev201/fig09_webapp_viewer.png
...
- DOCX run font mappings match Times New Roman / 바탕체: 404 runs
