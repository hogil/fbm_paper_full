...
**P2 핵심 수치 요약**: 대표 성과 FCM-PM val_margin 단일 모델 bit_F1 **0.9943** / Total FAR **0.00%** (현업 분포 모사 controlled benchmark 기준). bit-level majority voting ensemble 과 Knowledge Distillation single student 는 제출 대표 성과가 아니라 후속 안정성 및 추론 생산성 검토 항목으로 분리합니다.
