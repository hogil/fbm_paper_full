...
| 2026년 1월 ~ 현재 | P3. Trend Episode 데이터 생성 기반 Anomaly-detection 검증 PoC | 3인 PoC, 본인 70% 리딩. normal 3,500 + abnormal 3,500 = 총 7,000개 trend sample 구성 | BBD / Overlay / CD 담당 **9년** trend 판정 경험을 바탕으로 계측 밀도, noise 분포, 5종 anomaly pattern 을 episode generator parameter 로 옮기고, 합성 trend sample 약 7,000개를 구성했습니다. | 20% | 45% | 35% |
