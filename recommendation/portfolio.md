...
- **기술 지표**
  ...
  - **[실전 현업 데이터]** Unknown 검출은 특정 제품 실전 데이터 1만 장 학습 후, 학습에 쓰지 않은 별도 2,000장에 적용해 13개 후보 group 중 **7개 불량을 확인**해 운영 검출력이 검증되었습니다. 정답 label 이 없는 환경이라 정량 metric 대신 현업 확인 단계를 거쳤습니다.
