...
| Deep Learning (Architecture & Training) | ConvNeXtV2 Backbone (FCMAE Pretrained Fine-tuning), Loss Function Design (BCE / Focal / Asymmetric Loss), Label Smoothing, LR Scheduling (Warmup + Cosine), EMA, Optuna Hyperparameter Sweep |
